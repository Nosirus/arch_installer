...
POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(host context dir vcs status)
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(command_execution_time user time background_jobs virtualenv rbenv rvm)
...
POWERLEVEL9K_DIR_HOME_BACKGROUND='darkorange'
